              ...
              <div className="container">
                <div className="flex flex-col md:flex-row place-content-between items-center text-center md:text-left">
                  <div>
                    ...
                    <h1 className="text-4xl font-bold text-white">Fast & Flexible <span className="text-accent font-bold"><br className="block md:hidden"/>Game Servers.</span></h1>
                    ...
                    <div className="flex flex-col md:flex-row text-white md:space-x-4 pt-2 items-center">
                      <div className="flex items-center"><CpuChipIcon className="size-5 mr-1"/> 3.5Ghz+ EPYC 9654 | 5.7Ghz+ Ryzen 9950X</div>
                      <div className="flex items-center"><Cog6ToothIcon className="size-5 mr-1"/> Customized Control Panel</div>
                      <div className="flex items-center"><Square3Stack3DIcon className="size-5 mr-1"/> Raid-10 NVMe SSD Storage</div>
                    </div>
                    <ul id="features" className="list-disc list-inside text-muted text-xl py-3">
                        <li>High Speed, Purpose built Servers across all locations</li>
              ...
              <div className="container">
                <div className="flex flex-col md:flex-row place-content-between items-center text-center md:text-left">
                  <div>
                    ...
                    <h1 className="text-4xl font-bold text-white">Fast & Flexible <span className="text-accent font-bold"><br className="block md:hidden"/>Web Servers</span></h1>
                    <h2 className="text-2xl font-semibold text-muted pt-3">Investing in your community, one block at a time.<br /> Host with us today and enjoy high performance Hosting.</h2>
                    <div className="flex flex-col md:flex-row text-white md:space-x-4 pt-2 items-center">
                      <div className="flex items-center"><CpuChipIcon className="size-5 mr-1"/> 3.5Ghz+ EPYC 9654 | 5.7Ghz+ Ryzen 9950X</div>
                      <div className="flex items-center"><Cog6ToothIcon className="size-5 mr-1"/> Multiple Panels</div>
                      <div className="flex items-center"><Square3Stack3DIcon className="size-5 mr-1"/> Raid-10 NVMe SSD Storage</div>
                    </div>
                    <ul id="features" className="list-disc list-inside text-muted text-xl py-3">
